...
import { LifeExpectancyTrend } from "@/components/charts/LifeExpectancy";
      ...
      <main className="container mx-auto px-4 py-12">
          ...
          <TabsContent value="conditions">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Distribution of common health conditions in urban and rural
                  areas
                </CardDescription>
              </CardHeader>
          ...
          <TabsContent value="life-expectancy">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Historical trend of life expectancy in India
                </CardDescription>
              </CardHeader>
              <CardContent className="pt-6">
                <LifeExpectancyTrend />
          ...
          <TabsContent value="child-mortality">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Trend of under-5 mortality rate in India
                </CardDescription>
              </CardHeader>
              <CardContent className="pt-6">
                <ChildMortalityRate />
        ...
        >
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              Significant disparities exist in health outcomes between urban and
              rural areas in India.
            </li>
            <li>
              Certain health conditions show higher prevalence in rural regions
              compared to urban centers.
            </li>
            <li>
              Access to healthcare facilities varies greatly across different
              regions of India.
            </li>
            <li>
              Life expectancy in India has been steadily increasing over the
              past decades.
            </li>
            <li>
              Child mortality rates have significantly decreased, but
              there&apos;s still room for improvement.
            </li>
            <li>
              Targeted interventions are needed to address these disparities and
              improve overall health outcomes in India.
            </li>
          </ul>
        </motion.section>
      </main>
